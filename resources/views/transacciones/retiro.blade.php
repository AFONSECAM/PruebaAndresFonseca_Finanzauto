...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('retiro.store') }}" method="POST">
                ...
                <div class="col">
                    <div class="form-group">
                        <div class="input-group mt-4">
                            ...
                            <input type="number" class="form-control" id="valor" placeholder="Monto a retirar" name="valor">
                          </div>                    
                    </div>
                </div>
            </div>
            ...
            <input type="text" name="tipo" id="tipo" value="retiro" hidden>
        </form>
    </div>
    ...
    <script>
        ...
        function onChangeCliente(){
            ...
            //AJAX
            $.get('/api/transacciones/'+select_cliente+'/retiro', function (data){
